...
type InterestSet interface {
	GetInterest(month int, principal float64) float64
}
...
func (s LoanToValueInterestSet) GetInterest(_ int, principal float64) float64 {
...
func (s InterestUpdatesSet) GetInterest(month int, _ float64) float64 {
